...
const MemberActivities = () => {
  ...
  return (
    ...
    <div className="bg-gray-50 p-6 rounded shadow-md mt-5 relative max-w-full pr-4">
      <h2 className="text-[16px] font-semibold font-roboto text-gray-800 mb-5">Members Activities</h2>

      <div className="relative w-[65vw] overflow-hidden mr-2">
        ...
        <div
          className="absolute top-1/2 -translate-y-1/2  right-6 min-w-[200px] p-2 rounded-full flex items-center justify-center bg-gray-100 text-gray-600 font-medium  cursor-pointer hover:bg-gray-200 transition shadow mt-3"
        >
          
          <span className="flex items-center">View Full Details
